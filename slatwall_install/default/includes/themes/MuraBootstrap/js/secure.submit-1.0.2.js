    ...
    HPS = {
        ...
        configureElement: function (options) {
            ...
            $(this).submit(function (e) {
                ...
                //$("#creditCardNumber").removeAttr("name");
                //$("#card_cvc").removeAttr("name");
                //$("#exp_month").removeAttr("name");
                //$("#exp_year").removeAttr("name");

                $(".securesubmit-card-number").removeAttr("name");
                $(".securesubmit-card-cvc").removeAttr("name");
                $(".securesubmit-card-expiry-month").removeAttr("name");
                $(".securesubmit-card-expiry-year").removeAttr("name");
