...
<!--- <cfparam name="Form.securesubmitToken" default="NA"> --->
<!---[DEVELOPER NOTES]															
						...
						<div class="tab-content">
							...
							<cfif arrayLen($.slatwall.account().getAccountPaymentMethods())>
								<div class="tab-pane active" id="account-payment-methods">
									<form action="?s=1" method="post">
                                        <!--- <input type='hidden' class='securesubmitToken' name='securesubmitToken' value='#Form.securesubmitToken#'/> --->  
																			
										<!--- Hidden value to setup the slatAction --->
										<input id="slatActionApplyAccountPaymentMethod" type="hidden" name="slatAction" value="public:cart.placeOrder" />
							...
							<cfloop array="#eligiblePaymentMethods#" index="paymentDetails">
								...
								<div class="tab-pane#iif(first, de(' active'), de(''))#" id="tab#paymentDetails.paymentMethod.getPaymentMethodID()#">
									...
									<cfelse>
                                      <!--- TODO SAT Change form name value --->
										<form action="?s=1" method="post" name="securesubmit-payment-form">
											<!--- Hidden value to setup the slatAction --->
											<input id="slatActionAddOrderPayment" type="hidden" name="slatAction" value="public:cart.addOrderPayment" />
                <!--- TODO SAT Add hidden token field 
                <sw:FormField type="hidden" name="newOrderPayment.providerToken" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="providerToken" class="providerToken" />--->
                                            <input type="hidden" name="newOrderPayment.providerToken" value="#addOrderPaymentObj.getNewOrderPayment().getproviderToken()#"  class="providerToken" />
												...
												<div class="row">
													...
													<div class="span4">
														...
														<div class="control-group">
									    					...
									    					<div class="controls">
                                                                <!--- TODO SAT Change Class value --->
																<sw:FormField type="text" name="newOrderPayment.creditCardNumber" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="creditCardNumber" class="securesubmit-card-number" />
														...
														<div class="row">
															...
															<div class="span2">
																...
																<div class="control-group">
											    					...
											    					<div class="controls">
                                                                        <!--- TODO SAT Change Class value --->
																		<sw:FormField type="text" name="newOrderPayment.securityCode" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="securityCode" class="securesubmit-card-cvc" />
															...
															<div class="span2">
																...
																<div class="control-group">
											    					...
											    					<div class="controls pull-right">
											    						<!--- TODO SAT Change Class value --->
																		<sw:FormField type="select" name="newOrderPayment.expirationMonth" valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="expirationMonth" valueOptions="#addOrderPaymentObj.getNewOrderPayment().getExpirationMonthOptions()#" style="width:70px" class="securesubmit-card-expiry-month" />
                                                                        <!--- TODO SAT Change Class value --->
																		<sw:FormField type="select" name="newOrderPayment.expirationYear"  valueObject="#addOrderPaymentObj.getNewOrderPayment()#" valueObjectProperty="expirationYear" valueOptions="#addOrderPaymentObj.getNewOrderPayment().getExpirationYearOptions()#" style="width:70px" class="securesubmit-card-expiry-year" />
											...
											<div class="control-group pull-right">
												<div class="controls">
													<!--- This button will just add the order payment, but not actually process the order --->
													<button type="submit" class="securesubmit-submit-button" name="slatAction" onClick="$('##slatActionAddOrderPayment').val('public:cart.addOrderPayment');">Add Payment & Review</button>
													
													<!--- Clicking this button will not only add the payment, but it will also attempt to place the order. --->
                                                  <!--- TODO SAT Change Class value --->
													<button type="submit" class="securesubmit-submit-button" name="slatAction" onClick="$('##slatActionAddOrderPayment').val('public:cart.placeOrder');">Add Payment & Place Order</button>
												</div>
											</div>
										</form>
									</cfif>
